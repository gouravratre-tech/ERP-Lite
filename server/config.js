...
const SHEETS = {
  ...
  Quotations:     { name:'Quotations',     idField:'QuotationId',     prefix:'QT',  numeric:['Amount'], attachment:true,
    columns:['QuotationId','Date','CustomerId','QuotationNo','Description','Amount','Status','AttachmentUrl','Notes','CreatedDate'],
  ...
  Bills:          { name:'Bills',          idField:'BillId',          prefix:'BILL', numeric:['BaseAmount','GSTPercent','TotalAmount'], attachment:true,
    columns:['BillId','Date','CustomerId','BillNo','Description','BaseAmount','GSTPercent','TotalAmount','Status','GSTR1Filed','AttachmentUrl','Notes','CreatedDate'],
