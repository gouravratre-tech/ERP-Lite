...
const SHEETS = {
  ...
  PaymentsIn:     { name:'PaymentsIn',     idField:'PaymentInId',     prefix:'PIN', numeric:['Amount','TDS'],
    columns:['PaymentInId','Date','CustomerId','BillId','Mode','ReferenceNo','Amount','TDS','Notes','CreatedDate'],
    fieldMap:{ date:'Date', customerId:'CustomerId', billId:'BillId', mode:'Mode', referenceNo:'ReferenceNo', amount:'Amount', tds:'TDS', notes:'Notes' } },
